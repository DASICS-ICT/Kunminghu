...
object FuConfig {
  ...
  val LduCfg: FuConfig = FuConfig (
    ...
    exceptionOut = Seq(loadAddrMisaligned, loadAccessFault, loadPageFault, loadGuestPageFault, breakPoint, dasicsLoadFault, hardwareError),
    flushPipe = true,
    replayInst = true,
    hasLoadError = true,
    trigger = true,
  ...
  val StaCfg: FuConfig = FuConfig (
    ...
    piped = false,
    latency = UncertainLatency(),
    exceptionOut = Seq(storeAddrMisaligned, storeAccessFault, storePageFault, storeGuestPageFault, breakPoint, dasicsStoreFault),
    flushPipe = true,
    trigger = true,
  ...
  val HyldaCfg = FuConfig (
    ...
    writeFpRf = true,
    latency = UncertainLatency(3),
    exceptionOut = Seq(loadAddrMisaligned, loadAccessFault, loadPageFault, loadGuestPageFault, dasicsLoadFault),
    flushPipe = true,
    replayInst = true,
    hasLoadError = true,
    immType = Set(SelImm.IMM_I),
  ...
  val HystaCfg = FuConfig (
    ...
    piped = false,
    latency = UncertainLatency(),
    exceptionOut = Seq(storeAddrMisaligned, storeAccessFault, storePageFault, storeGuestPageFault,dasicsStoreFault),
    immType = Set(SelImm.IMM_S),
  )
